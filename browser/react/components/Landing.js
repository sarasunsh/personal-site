               ...
               <div id="forViewers" className="section text-center #90caf9 blue lighten-5">
                ...
                <div id="forAdv" className="section text-center blue lighten-3">
                      <div className="container landing">
                        ...
                        <div className="pitch ">
                          <img className='center-block round-corners' src="/img/smile/bestvideo.png" height="250"></img>
                            ...
                            <div className="row">
                                <div className="col s3 text-center">
                                    ...
                                    <div className="bio-text">
                                        Ben Brodsky loves speech synthesis and artificial intelligence. In his former life, he was involved in New York politics and moonlighted as a wedding singer. Go Eagles!<br></br><br></br>
                                        <div className='bio-contact'>
                                          <a href="ben@gmail.com">
                                            <img src="/img/email.png" height="20" />
                                          </a>
                                          <img src="/img/Github.png" height="20" />  github.com/ben<br></br>
                                          <img src="/img/linkedIn.png" height="20"/>  linkedin.com/in/ben
                                        </div>
                                    </div>
                                </div>
